...
interface TrainerInstance extends Model {
  id: number;
  photo: string;
  name: string,
  description: string,
...
export async function seedTrainerTranslations() {
  const trainers: {
    vakho: TrainerInstance | null;
    giorgi: TrainerInstance | null;
    vlad: TrainerInstance | null;
    kristine: TrainerInstance | null;
    nika: TrainerInstance | null;
    salome: TrainerInstance | null;
    teo: TrainerInstance | null;
    zura: TrainerInstance | null;
  } = {
